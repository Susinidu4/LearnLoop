  ...
  return (
    <div className="flex relative bg-[#fefaf8]">
      ...
      <div className="flex flex-col w-full ml-16">
        <Header />
        <div
          className={`${GlobalStyle.fontPoppins} min-h-screen pt-24 px-4 sm:px-8`}
        >
          {/* Title and Image Row */}
          <div className="pt-6">
              ...
              <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none leading-relaxed">
                <section className="space-y-4">
                  ...
                  <p className={`${GlobalStyle.paragraph} pl-4 ml-5`}>
                    ...
                    such as your name, email address, and profile information to
                  ...
                  <p className={`${GlobalStyle.paragraph} pl-4 ml-5`}>
                    ...
                    courses, features, and other users to improve our platform.
                  </p>
                  <p className={`${GlobalStyle.paragraph} pl-4 ml-5`}>
                    <strong>Cookies & Tracking:</strong> We use these to enhance
                    your user experience and ensure smooth functionality.
                  </p>
                </section>
                <br />
                ...
                <section className="space-y-4 ">
                  ...
                  <p className={`${GlobalStyle.paragraph} pl-4`}>
                    ...
                    may share data when required by law or to comply with legal
                    obligations.
                  </p>
                  <p className={`${GlobalStyle.paragraph} pl-4`}>
                    <strong className="ml-5">With service providers:</strong>{" "}
                    Trusted third-party vendors help us operate and enhance the
                    Learnloop platform.
                  </p>
                </section>
                <br />
                ...
                <section>
                  ...
                  <p className={`${GlobalStyle.paragraph} ml-9`}>
                    ...
                    no system is 100% secure, so please be cautious when <br/>sharing
                ...
                <section>
                  ...
                  <p className={`${GlobalStyle.paragraph} ml-9`}>
                    We may occasionally update this Privacy Policy. Please check
                    back regularly to stay informed of changes.
                  </p>
                </section>
                <br/>
              </div>
