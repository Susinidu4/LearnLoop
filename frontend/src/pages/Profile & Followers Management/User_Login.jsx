...
export const User_Login = () => {
  ...
  return (
    <div className="flex w-full min-h-screen bg-[#f8f0e5] relative overflow-hidden">
      <div className="absolute top-0 left-0 w-[500px] h-[500px] rounded-full bg-[#2F1B06] -translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute top-0 left-72 w-[400px] h-[400px] rounded-full bg-[#4a2b0f] -translate-x-1/2 -translate-y-1/2"></div>
      ...
      <main className={`${GlobalStyle.fontPoppins} container mx-auto flex flex-col md:flex-row items-center justify-center px-4 py-8 z-10 relative`}>
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-8">
          {/* <h1 className={`${GlobalStyle.headingLarge} text-[#4a2b0f] text-[100px] font-bold mb-6 drop-shadow-md`}>
            LearnLoop
          </h1> */}
